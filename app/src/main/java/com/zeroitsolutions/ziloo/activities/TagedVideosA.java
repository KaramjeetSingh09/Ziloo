...
public class TagedVideosA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(TagedVideosA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void callApiForGetAllvideos(boolean isProgressShow) {
        ...
        ApiVolleyRequest.JsonPostRequest(TagedVideosA.this, ApiLinks.showVideosAgainstHashtag, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String response) {
                Functions.checkStatus(TagedVideosA.this, response);
                if (isProgressShow) {
    ...
    private void openWatchVideo(int postion) {
        ...
        intent.putExtra("userId", Functions.getSharedPreference(TagedVideosA.this).getString(Variable.U_ID, ""));
    ...
    public void callApiFavHashtag() {
        ...
        ApiVolleyRequest.JsonPostRequest(TagedVideosA.this, ApiLinks.addHashtagFavourite, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String response) {
                Functions.checkStatus(TagedVideosA.this, response);
