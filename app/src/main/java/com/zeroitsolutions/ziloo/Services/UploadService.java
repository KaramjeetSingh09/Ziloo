package com.zeroitsolutions.ziloo.Services;
        ...
        if (intent != null && intent.getAction().equals("startservice")) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    uploadModel.setUserId(sharedPreferences.getString(Variable.U_ID, "0"));
                    uploadModel.setSoundId(Variable.selectedSoundId);
                    ...
                    map.put("user_id", sharedPreferences.getString(Variable.U_ID, "0"));
                    map.put("sound_id", Variable.selectedSoundId);
