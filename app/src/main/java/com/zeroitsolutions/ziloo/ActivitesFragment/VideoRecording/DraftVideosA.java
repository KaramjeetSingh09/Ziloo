...
import com.zeroitsolutions.ziloo.Adapters.DraftVideosAdapter;
...
public class DraftVideosA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(DraftVideosA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
                ...
                if (view.getId() == R.id.cross_btn) {
                    ...
                    if (item.video_duration_ms <= Constants.MAX_RECORDING_DURATION) {
                        ...
                        if (!Functions.isMyServiceRunning(DraftVideosA.this, new UploadService().getClass())) {
                            ...
                            chnageVideoSize(item.video_path, Functions.getAppFolder(DraftVideosA.this)+ Variable.gallery_resize_video);
                        } else {
                        ...
                        try {
                            startTrim(new File(item.video_path), new File(Functions.getAppFolder(DraftVideosA.this)+ Variable.gallery_trimed_video), 1000, 18000);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public void getAllVideoPathDraft() {
        ...
        String path = Functions.getAppFolder(this)+ Variable.DRAFT_APP_FOLDER;
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (result.equals("error")) {
                    ...
                    chnageVideoSize(Functions.getAppFolder(DraftVideosA.this)+Functions.getAppFolder(DraftVideosA.this)+ Variable.gallery_trimed_video, Functions.getAppFolder(DraftVideosA.this)+ Variable.gallery_resize_video);
                }
            }
    ...
    public void deleteFile() {
        ...
        File gallery_trim_video = new File(Functions.getAppFolder(this)+ Variable.gallery_trimed_video);
