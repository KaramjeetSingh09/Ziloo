...
import com.zeroitsolutions.ziloo.Adapters.UserShareProfileAdapter;
...
public class SendDirectMsg extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void callApiForGetAllSearchUser() {
        ...
        try {
            parameters.put("user_id", Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_ID, ""));
        ...
        ApiVolleyRequest.JsonPostRequest(SendDirectMsg.this, ApiLinks.searchFollowingOrFollowUsers, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
    ...
    private void callApiForGetAllfollower() {
        ...
        ApiVolleyRequest.JsonPostRequest(SendDirectMsg.this, ApiLinks.showFollowers, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String resp) {
                Functions.checkStatus(SendDirectMsg.this, resp);
    ...
    private void callApiForGetAllfollowing() {
        ...
        ApiVolleyRequest.JsonPostRequest(SendDirectMsg.this, ApiLinks.showFollowing, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String resp) {
                Functions.checkStatus(SendDirectMsg.this, resp);
    ...
    private void initControl() {
        ...
        senderId = Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_ID, "");
    ...
    public void sendvideo(FollowingModel item) {
        ...
        String senderId = Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_ID, "0");
        ...
        message_user_map.put("sender_name", Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_NAME, ""));
        ...
        rootref.updateChildren(user_map, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                sendermap.put("name", Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_NAME, ""));
                sendermap.put("pic", Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_PIC, ""));
                ...
                rootref.updateChildren(both_user_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        try {
                            notimap.put("title", Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_NAME, ""));
                        ...
                        ApiVolleyRequest.JsonPostRequest(SendDirectMsg.this, ApiLinks.sendPushNotification, notimap, Functions.getHeaders(SendDirectMsg.this), new InterfaceApiResponse() {
                            @Override
                            public void onResponse(String response) {
                                Functions.checkStatus(SendDirectMsg.this, response);
                            }
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                ...
                adduserInbox.updateChildren(both_user_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        ChatA.sendPushNotification(SendDirectMsg.this, Functions.getSharedPreference(SendDirectMsg.this).getString(Variable.U_NAME, ""), message,
                                receiverId, senderId);
