...
public class PrivacyPolicySettingA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(PrivacyPolicySettingA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void initControl() {
        ...
        privacyPolicySettingModel = (PrivacyPolicySettingModel) Paper.book(Variable.PrivacySetting).read(Variable.PrivacySettingModel);
    ...
    public void callApi() {
        ...
        try {
            ...
            params.put("user_id", Functions.getSharedPreference(PrivacyPolicySettingA.this).getString(Variable.U_ID, ""));

        } catch (Exception e) {
            e.printStackTrace();
        }

        ApiVolleyRequest.JsonPostRequest(PrivacyPolicySettingA.this, ApiLinks.addPolicySetting, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
