...
public class PushNotificationSettingA extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(PushNotificationSettingA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void initControl() {
        pushNotificationSettingModel = Paper.book(Variable.PrivacySetting).read(Variable.PushSettingModel);
    ...
    public void callApi() {
        ...
        try {
            ...
            params.put("user_id", Functions.getSharedPreference(PushNotificationSettingA.this).getString(Variable.U_ID, ""));

        } catch (Exception e) {
            e.printStackTrace();
        }

        ApiVolleyRequest.JsonPostRequest(PushNotificationSettingA.this, ApiLinks.updatePushNotificationSetting, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String response) {
                Functions.checkStatus(PushNotificationSettingA.this,response);
                parsedata(response);
            }
