...
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.InviteFriends.InviteFriendsFromContactsA;
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.Setting.NoInternetA;
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.Setting.QrCodeScannerA;
...
public class InviteFriendsA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(InviteFriendsA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
                ...
                switch (view.getId()) {
                    case R.id.action_txt:
                        if (Functions.checkLoginUser(InviteFriendsA.this)) {
                            if (!item.fb_id.equals(Functions.getSharedPreference(InviteFriendsA.this).getString(Variable.U_ID, "")))
    ...
    public void callSuggestionApi() {
        ...
        try {
            parameters.put("user_id", Functions.getSharedPreference(InviteFriendsA.this).getString(Variable.U_ID,""));
        ...
        ApiVolleyRequest.JsonPostRequest(InviteFriendsA.this, ApiLinks.showSuggestedUsers, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
    ...
    public void followUnFollowUser(final FollowingModel item, final int position) {
        ...
        Functions.callApiForFollowUnFollow(InviteFriendsA.this,
                Functions.getSharedPreference(InviteFriendsA.this).getString(Variable.U_ID, ""),
                item.fb_id,
                new APICallBack() {
                    @Override
