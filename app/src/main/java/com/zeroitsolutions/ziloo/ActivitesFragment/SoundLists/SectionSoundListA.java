...
public class SectionSoundListA extends AppCompatActivity implements Player.Listener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(SectionSoundListA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    public void callApi() {
        ...
        try {
            ...
            params.put("user_id", Functions.getSharedPreference(context).getString(Variable.U_ID, ""));

        } catch (Exception e) {
            e.printStackTrace();
        }

        ApiVolleyRequest.JsonPostRequest(SectionSoundListA.this, ApiLinks.showSoundsAgainstSection, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String response) {
                Functions.checkStatus(SectionSoundListA.this, response);
...
//                    }
    ...
    public void downLoadMp3(final String id, final String sound_name, String url) {
        ...
        prDownloader = PRDownloader.download(url, Functions.getAppFolder(SectionSoundListA.this) + Variable.APP_HIDED_FOLDER, Variable.SelectedAudio_AAC)
                .build();
    ...
    private void callApiForFavSound(final int pos, final SoundsModel item) {
        ...
        ApiVolleyRequest.JsonPostRequest(SectionSoundListA.this, ApiLinks.addSoundFavourite, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String response) {
                Functions.checkStatus(SectionSoundListA.this, response);
