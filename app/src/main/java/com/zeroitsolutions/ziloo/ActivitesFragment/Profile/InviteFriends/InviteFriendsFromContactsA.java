package com.zeroitsolutions.ziloo.ActivitesFragment.Profile.InviteFriends;
...
import com.zeroitsolutions.ziloo.Adapters.InviteFriendAdapter;
...
import com.zeroitsolutions.ziloo.Models.InviteFriendModel;
...
public class InviteFriendsFromContactsA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getSharedApp() {
        ...
        inviteAdapter = new ProfileSharingAdapter(InviteFriendsFromContactsA.this, getAppShareDataList(), (view, pos, object) -> {
    ...
    public void shareProfile(ShareAppModel item) {
        String profielLink = Variable.http+"://"+getString(R.string.share_profile_domain_second)+getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.U_ID,"");
...
//        }
    ...
    private void hitFacebookInvitationContactApi(JSONArray contactJSON) {
        ...
        try {
            ...
            parameters.put("user_id", Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.U_ID, ""));
        ...
        ApiVolleyRequest.JsonPostRequest(InviteFriendsFromContactsA.this, ApiLinks.showRegisteredContacts, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
    ...
    private void setUpFacebookContactAdapter() {
        ...
        usersAdapter = new FollowingAdapter(InviteFriendsFromContactsA.this,true,"",userList, (view, postion, item) -> {

            switch (view.getId()) {
                case R.id.action_txt:
                    if (Functions.checkLoginUser(InviteFriendsFromContactsA.this)) {
                        if (!item.fb_id.equals(Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.U_ID, "")))
    ...
    public void followUnFollowUser(final FollowingModel item, final int position) {
        ...
        Functions.callApiForFollowUnFollow(InviteFriendsFromContactsA.this,
                Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.U_ID, ""),
                item.fb_id,
                new APICallBack() {
                    @Override
    ...
    private void setUpContactAdapter() {
        ...
        adapter = new InviteFriendAdapter(datalist, (view, pos, object) -> {
            InviteFriendModel item= (InviteFriendModel) object;
            String profielLink = Variable.http+"://"+getString(R.string.share_profile_domain_second)+getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.U_ID,"");
            try {
                String fullName=Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.F_NAME,"")+" "+Functions.getSharedPreference(InviteFriendsFromContactsA.this).getString(Variable.L_NAME,"");
