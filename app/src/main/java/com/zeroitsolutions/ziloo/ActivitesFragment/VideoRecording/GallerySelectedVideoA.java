...
public class GallerySelectedVideoA extends AppCompatActivity implements View.OnClickListener, Player.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(GallerySelectedVideoA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
        ...
        if (getIntent().hasExtra("sound_name"))
        {
            ...
            if (isSelected.equals("yes")) {
                ...
                Variable.selectedSoundId = getIntent().getStringExtra("sound_id");
    ...
    public void goToPreviewActivity() {
        ...
        try {
            ...
            Functions.copyFile(videoPath,
                    new File(Functions.getAppFolder(this)+ Variable.outputfile2));
        }
        catch (Exception e) {
