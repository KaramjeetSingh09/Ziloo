...
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.SendDirectMsg;
import com.zeroitsolutions.ziloo.Adapters.FollowingShareAdapter;
import com.zeroitsolutions.ziloo.Adapters.ProfileSharingAdapter;
...
import com.zeroitsolutions.ziloo.Models.ShareAppModel;
...
public class VideoActionF extends BottomSheetDialogFragment implements View.OnClickListener, AdapterClickListener {
    ...
    View view;
    Context context;
    RecyclerView recyclerView, recyclerViewFollowing;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getContext();
        senderId = Functions.getSharedPreference(view.getContext()).getString(Variable.U_ID, "");
        ...
        if (userId != null && userId.equals(Functions.getSharedPreference(context).getString(Variable.U_ID, ""))) {
        ...
        if (Functions.getSharedPreference(context).getBoolean(Variable.IsExtended, false) && (item.allow_duet != null && item.allow_duet.equalsIgnoreCase("1"))
    ...
    public void setFollowingAdapter() {
        ...
        recyclerViewFollowing = view.findViewById(R.id.recylerview_following);
    ...
    public void sendvideo(FollowingModel followerItem) {
        ...
        String senderId = Functions.getSharedPreference(view.getContext()).getString(Variable.U_ID, "0");
        ...
        message_user_map.put("sender_name", Functions.getSharedPreference(view.getContext()).getString(Variable.U_NAME, ""));
        ...
        rootref.updateChildren(user_map, (databaseError, databaseReference) -> {
            ...
            rootref.updateChildren(both_user_map).addOnCompleteListener((OnCompleteListener<Void>) task -> {
                JSONObject notimap = new JSONObject();
                try {
                    notimap.put("title", Functions.getSharedPreference(view.getContext()).getString(Variable.U_NAME, ""));
                ...
                ApiVolleyRequest.JsonPostRequest(getActivity(), ApiLinks.sendPushNotification, notimap, Functions.getHeaders(getActivity()), new InterfaceApiResponse() {
                    @Override
    ...
    public void getSharedApp() {
        ...
        adapter = new ProfileSharingAdapter(context, getAppShareDataList(), (view, pos, object) -> {
    ...
    public void shareProfile(ShareAppModel item) {
        String videoLink = Constants.BASE_MEDIA_URL + "?" + Functions.getRandomString(3) + videoId + Functions.getRandomString(3);
        if (item.getName().equalsIgnoreCase(view.getContext().getString(R.string.message))) {
            moveToDirectMsg();
    ...
    private ArrayList<ShareAppModel> getAppShareDataList() {
        ArrayList<ShareAppModel> dataList = new ArrayList<>();
        {
            ...
            item.setName(getString(R.string.message));
...
//        }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.save_video_layout) {
            ...
            ClipboardManager clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
            ClipData clip = ClipData.newPlainText("Copied Text", Constants.BASE_MEDIA_URL + "?" + Functions.getRandomString(3) + videoId + Functions.getRandomString(3));
            clipboard.setPrimaryClip(clip);
        ...
        } else if (id == R.id.add_favourite_layout) {
            Bundle bundle = new Bundle();
            ...
            if (fragmentCallback != null)
                fragmentCallback.onResponce(bundle);
        } else if (id == R.id.not_intrested_layout) {
