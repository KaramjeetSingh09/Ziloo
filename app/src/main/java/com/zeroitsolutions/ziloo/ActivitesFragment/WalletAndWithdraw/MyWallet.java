...
public class MyWallet extends AppCompatActivity  implements View.OnClickListener, PurchasesUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(MyWallet.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
...
// && skuList.getPurchaseState()==Purchase.PurchaseState.PURCHASED
    ...
    public void Call_api_update_wallet(String name,String coins,String price,String Tid){
        ...
        try {
            params.put("user_id",Functions.getSharedPreference(MyWallet.this).getString(Variable.U_ID,""));
      ...
      MyWallet.super.runOnUiThread(new Runnable() {
          ...
          public void run() {
              ...
              ApiVolleyRequest.JsonPostRequest(MyWallet.this, ApiLinks.purchaseCoin, params, Functions.getHeaders(MyWallet.this), new InterfaceApiResponse() {
                  @Override
