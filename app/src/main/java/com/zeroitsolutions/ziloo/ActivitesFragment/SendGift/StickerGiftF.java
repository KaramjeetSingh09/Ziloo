...
public class StickerGiftF extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String wallet =""+Functions.getSharedPreference(view.getContext()).getString(Variable.U_WALLET, "0");
    ...
    private void hitSHowGiftScreen() {
        ...
        ApiVolleyRequest.JsonPostRequest(getActivity(), ApiLinks.showGifts, new JSONObject(), Functions.getHeaders(getActivity()), new InterfaceApiResponse() {
            @Override
    ...
    public void Call_api_Send_sticker(StickerModel model, int giftCount){
        ...
        try {
            params.put("sender_id", Variable.sharedPreferences.getString(Variable.U_ID,""));
        ...
        ApiVolleyRequest.JsonPostRequest(getActivity(), ApiLinks.sendGift, params, Functions.getHeaders(getActivity()), new InterfaceApiResponse() {
            @Override
            public void onResponse(String resp) {
                Functions.checkStatus(getActivity(),resp);
