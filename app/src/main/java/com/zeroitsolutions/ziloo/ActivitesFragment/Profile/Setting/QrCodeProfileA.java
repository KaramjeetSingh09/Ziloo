...
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.ShareItemViaIntentA;
import com.zeroitsolutions.ziloo.Constants;
import com.zeroitsolutions.ziloo.Interfaces.ShareIntentCallback;
import com.zeroitsolutions.ziloo.R;
import com.zeroitsolutions.ziloo.SimpleClasses.Functions;
import com.zeroitsolutions.ziloo.SimpleClasses.ImageSaver;
...
public class QrCodeProfileA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(QrCodeProfileA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
                , this, QrCodeProfileA.class, false);
        setContentView(R.layout.activity_qr_code_profile);

        inItControl();
        String profielLink = Variable.http + "://" + getString(R.string.share_profile_domain_second) + getString(R.string.share_profile_endpoint_second) + Functions.getSharedPreference(QrCodeProfileA.this).getString(Variable.U_ID, "");
    ...
    private void setUpScreenData() {
        String fullName = Functions.getSharedPreference(QrCodeProfileA.this).getString(Variable.F_NAME, "") + " " +
                Functions.getSharedPreference(QrCodeProfileA.this).getString(Variable.L_NAME, "");
        tvName.setText(fullName);
        String imgUrl = Functions.getSharedPreference(QrCodeProfileA.this).getString(Variable.U_PIC, "");
