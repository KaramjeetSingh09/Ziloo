...
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.FollowTab.FollowerUserF;
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.FollowTab.FollowingUserF;
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.FollowTab.SuggestedUserF;
...
public class FollowsMainTabA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(FollowsMainTabA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
