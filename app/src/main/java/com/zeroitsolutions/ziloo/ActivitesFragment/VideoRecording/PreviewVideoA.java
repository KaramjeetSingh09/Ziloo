...
import com.zeroitsolutions.ziloo.SimpleClasses.FilterType;
import com.zeroitsolutions.ziloo.Adapters.FilterAdapter;
...
public class PreviewVideoA extends AppCompatActivity implements Player.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(PreviewVideoA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
        ...
        selectPostion = 0;
        videoUrl = Functions.getAppFolder(this)+ Variable.outputfile2;
        ...
        findViewById(R.id.next_btn).setOnClickListener(v -> {
            ...
            if (selectPostion == 0) {
                ...
                try {
                    Functions.copyFile(new File(Functions.getAppFolder(this)+ Variable.outputfile2), new File(Functions.getAppFolder(this)+ Variable.output_filter_file));
                    gotopostScreen();
                } catch (Exception e) {
                    e.printStackTrace();
                    Functions.printLog(Constants.tag, e.toString());
                    saveVideo(Functions.getAppFolder(this)+ Variable.outputfile2, Functions.getAppFolder(this)+ Variable.output_filter_file);
                }
