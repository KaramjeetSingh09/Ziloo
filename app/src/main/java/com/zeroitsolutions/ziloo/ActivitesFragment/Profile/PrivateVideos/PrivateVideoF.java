package com.zeroitsolutions.ziloo.ActivitesFragment.Profile.PrivateVideos;
...
public class PrivateVideoF extends Fragment {
    ...
    private void openWatchVideo(int postion) {
        ...
        intent.putExtra("userId",Functions.getSharedPreference(context).getString(Variable.U_ID, ""));
