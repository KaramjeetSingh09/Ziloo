...
import com.zeroitsolutions.ziloo.TrimModule.CompressOption;
import com.zeroitsolutions.ziloo.TrimModule.CustomProgressView;
import com.zeroitsolutions.ziloo.TrimModule.FileUtils;
import com.zeroitsolutions.ziloo.TrimModule.TrimVideo;
import com.zeroitsolutions.ziloo.TrimModule.TrimVideoOptions;
...
public class ActVideoTrimmer  extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(ActVideoTrimmer.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
...
//              String path = FileUtils.getPath(ActVideoTrimmer.this, uri);
    ...
    private void trimVideo() {
        if (isValidVideo) {
            ...
            outputPath = Functions.getAppFolder(ActVideoTrimmer.this)+ Variable.gallery_trimed_video;
            ...
            new Thread(() -> {
                ...
                if (result == 0) {
                    ...
                    if (showFileLocationAlert)
                        ...
                        intent.putExtra(Variable.gallery_trimed_video, outputPath);
    ...
    private void showLocationAlert() {
        ...
        openFileLocationDialog.setOnDismissListener(dialogInterface -> {
            Intent intent = new Intent();
            intent.putExtra(Functions.getAppFolder(ActVideoTrimmer.this)+ Variable.APP_HIDED_FOLDER, outputPath);
            setResult(RESULT_OK, intent);
            finish();
        });
