...
public class SubmitReportA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(SubmitReportA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    public void callApiReportVideo() {
        ...
        try {
            ...
            params.put("user_id", Functions.getSharedPreference(SubmitReportA.this).getString(Variable.U_ID, ""));
        ...
        ApiVolleyRequest.JsonPostRequest(SubmitReportA.this, ApiLinks.reportVideo, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
    ...
    public void callApiReportUser() {
        ...
        Functions.showLoader(SubmitReportA.this, false, false);
        ApiVolleyRequest.JsonPostRequest(SubmitReportA.this, ApiLinks.reportUser, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
