...
import static com.zeroitsolutions.ziloo.ActivitesFragment.LiveStreaming.Constants.PREF_RESOLUTION_IDX;
...
import com.zeroitsolutions.ziloo.ActivitesFragment.LiveStreaming.ui.ResolutionAdapter;
...
public class SettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(SettingsActivity.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
