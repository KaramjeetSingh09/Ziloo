...
public class ManageProfileA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(ManageProfileA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
...
//        if (TextUtils.isEmpty(Functions.getSharedPreference(ManageProfileA.this).getString(Variable.U_SOCIAL_ID, ""))) {
//            tvAccountInformation.setVisibility(View.VISIBLE);
//            hideAbleView.setVisibility(View.VISIBLE);
//
//            if (TextUtils.isEmpty(Functions.getSharedPreference(ManageProfileA.this).getString(Variable.U_PHONE_NO, ""))) {
...
//                tvEmail.setText(Functions.getSharedPreference(ManageProfileA.this).getString(Variable.U_EMAIL, ""));
//            } else {
...
//                tvPhoneNo.setText(Functions.getSharedPreference(ManageProfileA.this).getString(Variable.U_PHONE_NO, ""));
//            }
//
//        } else {
//            tabChangePhoneNo.setVisibility(View.GONE);
