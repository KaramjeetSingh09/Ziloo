...
import com.zeroitsolutions.ziloo.Adapters.UsersAdapter;
...
public class FriendsA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(FriendsA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void callApiForOtherUsers() {
        ...
        ApiVolleyRequest.JsonPostRequest(FriendsA.this, ApiLinks.search, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
    ...
    private void callApiForGetAllfollowing(boolean isProgressShow) {
        ...
        ApiVolleyRequest.JsonPostRequest(FriendsA.this, ApiLinks.showFollowing, parameters, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String resp) {
                Functions.checkStatus(FriendsA.this,resp);
                if (isProgressShow)
