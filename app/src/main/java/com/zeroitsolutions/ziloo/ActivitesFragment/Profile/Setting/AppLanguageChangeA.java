...
import com.zeroitsolutions.ziloo.Adapters.LanguageAdapter;
import com.zeroitsolutions.ziloo.Constants;
import com.zeroitsolutions.ziloo.Interfaces.AdapterClickListener;
import com.zeroitsolutions.ziloo.Models.LanguageModel;
...
public class AppLanguageChangeA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(AppLanguageChangeA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void setUpAdapter() {
        ...
        for (int i=0;i<localeName.length;i++)
        {
            ...
            if (Functions.getSharedPreference(AppLanguageChangeA.this)
                    .getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE).equalsIgnoreCase(localeKey[i]))
            {
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            ...
            case R.id.tvDone:
            {
                ...
                editor2.putString(Variable.APP_LANGUAGE, selectedLanguage.getName());
                editor2.putString(Variable.APP_LANGUAGE_CODE, selectedLanguage.getKey());
                editor2.commit();
