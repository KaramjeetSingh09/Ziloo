...
import com.zeroitsolutions.ziloo.SimpleClasses.FileUtils;
...
public class ProfileVarificationA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(ProfileVarificationA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
    ...
    private void setUpScreendata() {
        ...
        if (Functions.getSharedPreference(ProfileVarificationA.this).getString(Variable.IS_VERIFICATION_APPLY, "0").equalsIgnoreCase("1"))
        {
        ...
        usernameEdit.setText(Functions.getSharedPreference(ProfileVarificationA.this).getString(Variable.U_NAME, ""));
        fullnameEdit.setText(Functions.getSharedPreference(ProfileVarificationA.this).getString(Variable.F_NAME, "") + " " + Functions.getSharedPreference(ProfileVarificationA.this).getString(Variable.L_NAME, ""));
    ...
    public void callApi() {
        ...
        try {
            params.put("user_id", Functions.getSharedPreference(ProfileVarificationA.this).getString(Variable.U_ID, ""));
        ...
        ApiVolleyRequest.JsonPostRequest(ProfileVarificationA.this, ApiLinks.userVerificationRequest, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String resp) {
                ...
                try {
                    ...
                    if (code.equalsIgnoreCase("200")) {
                        ...
                        Functions.showToast(ProfileVarificationA.this, msg);
                        ProfileVarificationA.super.onBackPressed();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
