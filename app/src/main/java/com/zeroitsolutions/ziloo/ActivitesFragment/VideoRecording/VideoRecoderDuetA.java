...
public class VideoRecoderDuetA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(VideoRecoderDuetA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
        ...
        if (!isRecording && secPassed < (Constants.RECORDING_DURATION / 1000) - 1) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    File file = new File(Functions.getAppFolder(VideoRecoderDuetA.this) + Variable.APP_HIDED_FOLDER + "myvideo" + (number) + ".mp4");
                    videopaths.add(Functions.getAppFolder(VideoRecoderDuetA.this) + Variable.APP_HIDED_FOLDER + "myvideo" + (number) + ".mp4");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    outputFilePath = Functions.getAppFolder(VideoRecoderDuetA.this) + Variable.outputfile2;
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            if (cameraView.isFacingFront()) {
                                changeFlipedVideo(Functions.getAppFolder(VideoRecoderDuetA.this) + Variable.outputfile2, Functions.getAppFolder(VideoRecoderDuetA.this) + Variable.output_filter_file);
                            } else
                                goToPostActivity();
    ...
    public void goToPostActivity() {
        try {
            Functions.copyFile(new File(Functions.getAppFolder(this) + Variable.outputfile2),
                    new File(Functions.getAppFolder(this) + Variable.output_filter_file));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void deleteFile() {
        ...
        File output = new File(Functions.getAppFolder(this) + Variable.outputfile);
        File output2 = new File(Functions.getAppFolder(this) + Variable.outputfile2);

        File gallery_trimed_video = new File(Functions.getAppFolder(this) + Variable.gallery_trimed_video);
        File gallery_resize_video = new File(Functions.getAppFolder(this) + Variable.gallery_resize_video);
        ...
        for (int i = 0; i <= 12; i++) {
            ...
            File file = new File(Functions.getAppFolder(VideoRecoderDuetA.this) + Variable.APP_HIDED_FOLDER + "myvideo" + (i) + ".mp4");
            if (file.exists()) {
                file.delete();
            }
        }
