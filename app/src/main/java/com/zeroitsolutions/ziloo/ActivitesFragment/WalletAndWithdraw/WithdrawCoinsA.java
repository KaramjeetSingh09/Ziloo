package com.zeroitsolutions.ziloo.ActivitesFragment.WalletAndWithdraw;
...
import com.zeroitsolutions.ziloo.ActivitesFragment.Profile.Setting.AddPayoutMethodA;
...
public class WithdrawCoinsA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Functions.setLocale(Functions.getSharedPreference(WithdrawCoinsA.this).getString(Variable.APP_LANGUAGE_CODE, Variable.DEFAULT_LANGUAGE_CODE)
        ...
        String wallet =""+Functions.getSharedPreference(WithdrawCoinsA.this).getString(Variable.U_WALLET, "0");
    ...
    public void Call_api_get_coins_value(){
        ...
        ApiVolleyRequest.JsonPostRequest(this, ApiLinks.showCoinWorth, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
...
//            params.put("paypal_id",payment_edit.getText().toString());
        ...
        ApiVolleyRequest.JsonPostRequest(this, ApiLinks.withdrawRequest, params, Functions.getHeaders(this), new InterfaceApiResponse() {
            @Override
            public void onResponse(String resp) {
                Functions.checkStatus(WithdrawCoinsA.this,resp);
