...
public class SearchSoundF extends RootFragment implements Player.Listener {
            ...
            if (code.equals("200")) {
                ...
                for (int i = 0; i < msgArray.length(); i++) {
                    ...
                    if (thum_image != null && thum_image.contains("http"))
                        ...
                        item.thum = Constants.BASE_MEDIA_URL + itemdata.optString("thum");
    ...
    public void downLoadMp3(final String id, final String sound_name, String url) {
        ...
        prDownloader = PRDownloader.download(url, Functions.getAppFolder(getActivity())+ Variable.APP_HIDED_FOLDER, sound_name + id)
                .build();
