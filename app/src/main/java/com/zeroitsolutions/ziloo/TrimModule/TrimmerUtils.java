package com.zeroitsolutions.ziloo.TrimModule;
    ...
    public static int getFrameRate(Activity context, Uri videoPath) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P) {
                frameRate = Integer.parseInt(retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_VIDEO_FRAME_COUNT));
            }
            retriever.release();
            return frameRate;
        } catch (Exception e) {
